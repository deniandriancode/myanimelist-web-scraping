...
def get_anime_review(page):
    ...
    for review in review_elements:
        try:
            ...
            anime_review.append([anime_title, anime_link, mal_user, mal_user_link, review_status, additional_flag, review_content, reviewer_rating])
        except Exception:
